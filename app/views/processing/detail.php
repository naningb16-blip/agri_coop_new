...
<div class="mb-3 d-flex gap-2">
    <a href="<?= BASE_URL ?>/processing" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Back</a>
...
function startStage(stageId) {
    ...
    fetch(BASE_URL + '/processing/update-stage', { method: 'POST', body: fd })
