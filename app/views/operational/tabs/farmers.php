<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <button class="btn btn-sm btn-success ms-auto" data-bs-toggle="modal" data-bs-target="#farmerModal" onclick="resetForm()"><i class="bi bi-plus-circle me-1"></i>Add Farmer</button>
    <?php endif; ?>
</div>
...
<div class="modal fade" id="farmerModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= BASE_URL ?>/operational/save-farmer" method="POST" data-ajax data-reload="true">
