...
<div class="alert alert-info mb-3">
    ...
    <strong>GM View Mode:</strong> You can view all production data for approval context, but can only approve/reject requests through the Approvals section.
</div>
<?php endif; ?>
...
<div class="table-card mb-3">
    <div class="p-3 d-flex gap-2 flex-wrap align-items-center">
        ...
        <a href="<?= BASE_URL ?>/production?status=<?= $v ?>" class="btn btn-sm <?= $status===$v ? 'btn-primary' : 'btn-outline-secondary' ?>"><?= $l ?></a>
        <?php endforeach; ?>
        <div class="ms-auto d-flex gap-2">
            <a href="<?= BASE_URL ?>/production/farmers" class="btn btn-sm btn-outline-secondary"><i class="bi bi-people me-1"></i>Farmers</a>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tr>
                ...
                <td><a href="<?= BASE_URL ?>/production/detail?id=<?= $r['id'] ?>" class="btn btn-xs btn-outline-primary"><i class="bi bi-eye"></i></a></td>
            </tr>
            <?php endforeach; ?>
...
<div class="modal fade" id="newProdModal" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="<?= BASE_URL ?>/production/create" method="POST" data-ajax data-reload="true">
